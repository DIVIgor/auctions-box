...
from .views import LogInView, LogOutView, UserView, ChangeInfoView, ChangePassView, ChangePassDoneView


app_name = 'account'

urlpatterns = [
    path("login", LogInView.as_view(success_url=reverse_lazy('auctions:index')), name="login"),
